...
export default function Login() {
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] bg-white dark:bg-gray-900 flex transition-colors duration-200">
                                    ...
                                    <div className="mt-6 flex flex-col gap-3">
                                        <div>
                                            <button
                                                ...
                                                className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                                            >
                                        ...
                                        <div>
                                            <button
                                                ...
                                                className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-transparent rounded-md shadow-sm bg-[#24292e] hover:bg-[#2f363d] text-sm font-medium text-white transition-colors"
                                            >
